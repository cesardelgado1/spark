...
//    protected $objectives;
//
//    public function __construct($sp_id, $fy, $department="Todos", $topics = [], $goals = [], $objectives = [])
//    {
//        $this->sp_id = $sp_id;
//        $this->fy = $fy;
...
////            ->where('I.i_FY', $this->fy);
////
////        // ✅ Apply department filter only if not "Todos"
////        if ($this->department !== "Todos") {
////            $query->where('RR.department', $this->department);
////        }
////        $query->select(
////            'SP.sp_id', 'SP.sp_institution',
////            'T.t_id', 'T.t_num', 'T.t_text',
...
//    protected $department;
//
//    public function __construct($sp_id, $fy, $topics = [], $goals = [], $objectives = [], $department = null)
//    {
//        $this->sp_id = $sp_id;
//        $this->fy = $fy;
//        $this->topics = $topics;
...
//        $data = $query->get();
//
//        // NEW: Replace i_value with iv_value if Decanato is selected
//        if ($this->department && $this->department !== 'Todos') {
//            $userIds = DB::table('role_requests')
//                ->where('department', $this->department)
//                ->pluck('user_id')
//                ->toArray();
//
//            foreach ($data as $item) {
//                $iv_value = DB::table('indicator_values')
//                    ->where('iv_ind_id', $item->i_id)
//                    ->whereIn('iv_u_id', $userIds)
//                    ->pluck('iv_value')
//                    ->implode(', '); // Concatenate if multiple values
//
//                $item->i_value = $iv_value ?: 'N/A'; // Replace i_value with iv_value or show N/A
//            }
//        }
//
//        foreach ($data as $item) {
