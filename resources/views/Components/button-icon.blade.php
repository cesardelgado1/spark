@props(['type' => 'create', 'href' => '#'])

<a href="{{ $href }}" class="inline-flex items-center px-2 py-2 bg-[#1F2937] border border-gray-300 rounded-full shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
    @if($type === 'create')
