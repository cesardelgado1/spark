<x-layout>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-3 items-center ml-10">
                ...
                <a href="{{ route('strategicplans.create',['institution' => $institution]) }}"
                   class="inline-flex items-center justify-center w-8 h-8 bg-blue-500 text-white rounded-full shadow hover:bg-blue-700 transition"
                ...
                {{-- Toggle checkboxes to delete plans --}}
                ...
                {{-- Enter edit mode --}}
                <button onclick="enterEditMode()" class="inline-flex items-center justify-center w-8 h-8 bg-[#ff9800] text-white rounded-full shadow hover:bg-[#ff9800] transition"
                        title="Editar Planes">
                    {{-- Edit icon --}}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 text-white">
    ...
    {{-- Banner shown when edit mode is active --}}
    ...
    <div class="px-6 py-4">
        @if(count($strategicplans) > 0)
            {{-- Form for bulk deleting strategic plans --}}
            <form id="delete-form" action="{{ route('strategicplans.bulkDelete',['institution' => $institution]) }}" method="POST">
                ...
                {{-- Buttons shown when delete mode is active --}}
            ...
            <div id="confirm-modal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 hidden">
                <div class="bg-white w-1/3 rounded-lg shadow-lg p-6">
                    <h2 class="text-lg font-bold mb-4">¿Estás seguro de borrar este(os) plan(es)?</h2>
    ...
    {{-- JavaScript section --}}
    <script>
        // Toggle visibility of checkboxes and delete buttons
        ...
        // Cancel delete mode and uncheck checkboxes
        ...
        // Redirect to edit page when a plan is clicked in edit mode
        ...
        // Show confirmation modal if at least one checkbox is selected
