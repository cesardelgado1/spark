<x-layout>
    ...
    <x-slot:heading>
        ...
        <button onclick="enterGoalEditMode()" class="inline-flex items-center justify-center w-8 h-8 bg-[#ff9800] text-white rounded-full shadow hover:bg-[#ff9800] transition"
                title="Editar Metas">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 text-white">
