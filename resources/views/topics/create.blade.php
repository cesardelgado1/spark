    ...
    <div class="px-6 py-4">
        <form action="{{ route('topics.store', $strategicplan) }}" method="POST">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <a href="{{ route('strategicplans.topics', $strategicplan->sp_id) }}" class="rounded-md bg-gray-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500">Cancelar</a>
