...
<body class="h-full">
    <div class="flex h-screen bg-gray-100">
        ...
        {{--NAVIGATION SIDEBAR--}}
        <div class="hidden md:flex flex-col w-64 bg-[#2d3745]">
            {{--Logo, Title & Toggle button--}}
            <div class="flex items-center h-16 px-20 b">
                <span class="text-white font-bold uppercase">SPARK</span>
                <button class="text-white ml-20 focus:outline-none focus:text-gray-700">
            ...
            <div class="flex flex-col flex-1 overflow-y-auto">
                <nav class="flex-1 px-2 py-4 ">
                    ...
                    <a href="#" class="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700">
                        <svg class="h-6 w-6 mr-2"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round">
        ...
        <main class="flex flex-col flex-1 overflow-y-auto">
            ...
            <header class="flex items-center justify-between h-16 bg-[#1F2937] border-b border-gray-200">
                ...
                <button class="text-white border border-white px-4 py-2 rounded hover:bg-gray-700 focus:outline-none ml-auto mr-10">
                    Iniciar Sesión
                </button>
            </header>
            {{--PAGE CONTENT--}}
            <div class="p-4">
                <h1 class="text-2xl font-bold">Welcome to SPARK!</h1>
            </div>
        </main>
